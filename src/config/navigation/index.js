...
import { CreateAccount, GenderScreen, IntrestScreen,
   Introductionliderscreen, LoginWithNumber, VerificationCode, NameScreen,
    SignUp, Login, Forget, NewPassword, ProfileDetails, DatingPage, EditProfile, 
    ViewStory, MassageScreen, SwipPAge, UserProfile, DiscoverScreen, ChatScreen, 
    TextScreen, MatchScreen,PaymentScreen } from '../../screens';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: false }} >
        ...
        <Stack.Screen name="paid" component={PaymentScreen} />
